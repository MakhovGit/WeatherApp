package com.pogoda.app.ru.ui.theme
...
val ButtonPressedColor = Color(0xFF68BDFF)
val ButtonTextColor = Color.Black
val InterfaceBlockColor = Color(0xFFDBEFFF)
val IndicatorEmptyColor = Color(0xFFFCFEFF)
val IndicatorFilledColor = Color(0xFF68BDFF)